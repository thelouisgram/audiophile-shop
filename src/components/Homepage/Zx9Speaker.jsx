...
const Zx9Speaker = () => {
  return (
      <div className="w-full bg-whitishGrey px-4 xs:px-6 md:p-0 mb-6 mt-10 md:mt-20 md:mb-12">
          <section className="speaker w-full flex py-10 md:pb-0 md:pt-24 h-auto rounded-[10px] bg-orange md:w-[1100px] mx-auto ">
              <div className="w-full h-auto px-5 md:px-0">
                  <div className="flex justify-center h-auto flex-col md:flex-row">
                      ...
                      <div className="md:mt-[15px] flex flex-col text-center md:text-left items-center md:items-start">
                          <h2 className="text-[28px] xs:text-[48px] md:text-[56px] text-white font-bold tracking-[0.1em] leading-[1.1em] mb-8">
                              ZX9 <br />
                              SPEAKER
                          </h2>
                          <p className="w-full md:w-[325px] text-white text-[13px] md:text-[15px] mb-10">
