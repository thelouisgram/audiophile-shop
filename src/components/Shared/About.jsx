...
const About = () => {
  return (
    // Parent Container
      <div className='md:w-[1100px] my-28 ss:my-40 px-4 xs:px-6 md:px-0 flex flex-col-reverse md:flex-row items-center gap-8 
      mx-auto'>
        <div className='md:w-1/2 text-center md:text-left'>
          ...
          <p className='text-elements ss:w-[575px] md:w-[495px] text-[12px] xs:text-[15px]'>Located at the heart of New York City,
        ...
        <div className='md:w-1/2'>
          ...
          {/* Tablet Image */}
          <img src='/images/shared/tablet/image-best-gear.jpg' className="w-full h-auto rounded-[15px] hidden md:first-letter:hidden ss:flex" />
          {/* Mobile Image */}
