    ...
    <div className="w-full fixed h-[100vh] z-[201] bg-blackII">
      <div className="flex justify-center items-center w-full h-full px-4 xs:px-6 md:px-0">
        <div className="bg-white rounded-[10px] w-full md:w-[550px] p-6 xs:p-8 md:p-12 flex gap-6 xs:gap-8 flex-col">
          <img src="/images/shared/desktop/icon-check-mark.svg" className="w-[48px] md:w-[72px]" alt="Check Mark" />
          <h1 className="text-[20px] xs:text-[28px] md:text-[32px] text-black font-bold leading-[1.1em]">THANK YOU <br /> FOR YOUR ORDER</h1>
          <p className="text-elements">You will receive an email confirmation shortly.</p>
          <div className="w-full flex flex-col md:flex-row h-auto rounded-[5px] overflow-hidden mb-4">
            {!fullItems ? (
              <SingleItem
                items={items}
            ...
            <div className="bg-black px-4 xs:px-6 md:w-1/2 h-[100px] xs:h-[125px] flex flex-col gap-3 justify-center font-bold">
