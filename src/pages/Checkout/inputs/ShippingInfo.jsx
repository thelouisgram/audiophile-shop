    ...
    <div>
      <div className="flex flex-col w-full md:w-auto mb-6">
        <div className="flex justify-between items-center w-full mb-2">
          <label
            className={`text-[13px] font-bold ${
              errors.address ? "text-strawberryRed" : "text-black"
            }`}
            htmlFor="address"
          >
            Your Address
          ...
          {errors.address && (
            <span className="text-[13px] text-strawberryRed">
              {errors.address}
            </span>
          )}
        </div>
        <input
          ...
          onChange={onChange}
          className={`${
            errors.address ? "border-strawberryRed" : "border-greyBorder"
      ...
      <div className="flex flex-col ss:flex-row gap-6 md:gap-0 justify-between mb-6">
        <div className="flex flex-col w-full md:w-auto">
          <div className="flex justify-between items-center w-full md:w-[300px] mb-2">
            <label
              className={`text-[13px] font-bold ${
                errors.city ? "text-strawberryRed" : "text-black"
              }`}
              htmlFor="city"
            >
              City
          ...
          <input
            ...
            onChange={onChange}
            className={`${
              errors.city ? "border-strawberryRed" : "border-greyBorder"
        ...
        <div className="flex flex-col w-full md:w-auto">
          <div className="flex justify-between items-center w-full md:w-[300px] mb-2">
            <label
              className={`text-[13px] font-bold ${
                errors.country ? "text-strawberryRed" : "text-black"
              }`}
              htmlFor="country"
            >
              Country
          ...
          <input
            ...
            onChange={onChange}
            className={`${
              errors.country ? "border-strawberryRed" : "border-greyBorder"
            } px-4 rounded-[5px] py-4 border-[1px] w-full md:w-[300px] text-[14px] placeholder:text-elements placeholder:font-medium font-bold focus:outline-[1px] focus:outline-orange`}
          />
        </div>
      </div>
      ...
      <div className="flex flex-col ss:flex-row gap-6 md:gap-0 justify-between mb-6">
        <div className="flex flex-col w-auto ss:w-1/2 md:w-full">
          <div className="flex justify-between items-center w-full md:w-[300px] mb-2">
            <label
              className={`text-[13px] font-bold ${
                errors.postalCode ? "text-strawberryRed" : "text-black"
              }`}
              htmlFor="postalCode"
            >
              Postal Code
          ...
          <input
            ...
            onChange={onChange}
            className={`${
              errors.postalCode ? "border-strawberryRed" : "border-greyBorder"
            } px-4 rounded-[5px] py-4 border-[1px] w-full md:w-[300px] text-[14px] placeholder:text-elements placeholder:font-medium font-bold focus:outline-[1px] focus:outline-orange`}
          />
        </div>
