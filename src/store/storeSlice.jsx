...
export const { toggleCart, updateCart, updateCartTotal, updateCartItemsNumber, updateVat, updateGrandTotal, updateCompleteOrder, updateThankYou } = storeSlice.actions